...
param <- data.frame( 
    ...
    "name"           = c( "GW-M", "Met-M0",  "Met-M1",      "Met-M2", "GW-N", "GW-N1" ), 
    ...
    "diff_coef"      = 5E-10, 
    "parent_id"      = c(     NA,      "1",     "1|2",       "1|3|5",     NA,     "5" ), 
    "g_per_mol"      = c(    381,      367,       183,           140,    395,     154 ), 
    "transf_f"       = c(     NA,    "0.2", "0.2|1.0", "0.2|1.0|1.0",     NA,   "1.0" ), # mol met formed / mol parent degraded
