...
and the dose(s) will be overwritten by `macrounchainedFocusGW()`.
...
But the user will most of the time want to use his/ her own 
...
#   Fetch the path to an example template par-file:
pf <- system.file( 
    "par-files", "chat_pot_GW-X_900gHa_d182_biennial.par", 
...
different (likely `'GlobalEnv'` instead of `'macrounchained'`) 
